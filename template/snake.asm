...
beq v0, zero,main_case_no_hit
addi t0,zero,1
beq v0,t0, main_case_hit_food
addi t0,zero,2
...
ldw t1, SCORE(zero)
beq t1, zero, end_save_cp

addi t2, zero, 9
addi t3, zero, 0

loop_save_cp:
	bge t2, t1, out_of_loop
	addi t1, t1, -10
	addi t3, t3, 10 ; tenth 
	jmpi loop_save_cp
...
beq t3,zero , end_save_cp 
bne t1, zero, end_save_cp
