...
jmpi dont_do_test_ex5
	...
	call hit_test
	addi t0, zero, 1
	beq v0, t0, goto_create_food ;t0 = 1

	addi t0, t0, 1

	beq v0, t0, end_test_ex5 ;t0 = 2

	beq v0, zero, goto_no_collision
...
call hit_test
	addi t0, zero, 1
	beq v0, t0, goto_create_food_gecko ;t0 = 1

	addi t0, t0, 1

	beq v0, t0, end_test_gecko_basic ;t0 = 2

	beq v0, zero, goto_no_collision_gecko

	goto_create_food_gecko:
	call create_food
	
	goto_no_collision_gecko:
...
wait_main:
	...
	loop_wait_main:
	addi t7, t7, 1
	bne t7, t6, loop_wait_main

ret

;test_gecko_basic_snake
